    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="relative h-[60vh] flex items-center justify-center">
        ...
        <div className="relative z-10 text-center text-white">
          <h1 className="text-4xl md:text-6xl font-bold mb-4">Subdivisions Parfums</h1>
      ...
      <section className="max-w-7xl mx-auto py-16 px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            { size: "5ml", description: "Perfect for trying new scents" },
            { size: "10ml", description: "Ideal for your collection" },
            { size: "Full Size", description: "Complete luxury experience" },
          ].map((category) => (
            <div
              key={category.size}
            ...
            >
              <div className="p-6">
                ...
                <button className="w-full text-gray-600 hover:text-gray-900 flex items-center justify-center group-hover:translate-x-2 transition-transform">
                  Shop {category.size}
      ...
      {/* Featured Products */}
      <section className="max-w-7xl mx-auto py-16 px-4">
        <h2 className="text-3xl font-bold mb-8 text-center text-gray-900">Featured Fragrances</h2>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {Array.from({ length: 4 }).map((_, i) => (
            <div key={i} className="group bg-white rounded-lg border border-gray-200 shadow-sm">
              <div className="p-4">
                <div className="relative h-48 mb-4 overflow-hidden rounded-md">
                  <img
                ...
                <h3 className="font-semibold mb-1 text-gray-900">Signature Scent {i + 1}</h3>

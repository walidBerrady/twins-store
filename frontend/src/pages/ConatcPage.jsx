...
const Contact = () => {
  ...
  return (
    <div className="bg-white">
      {/* Hero section */}
      <div className="relative bg-gradient-to-r from-purple-600 to-indigo-700 h-60 flex items-center">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl font-extrabold tracking-tight text-white sm:text-5xl">Contact Us</h1>
          <p className="mt-4 max-w-lg mx-auto text-xl text-indigo-100 sm:max-w-3xl">We'd love to hear from you</p>
        </div>
      </div>
        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-16">
          ...
          <div>
            ...
            <p className="mt-4 text-lg text-gray-500">
              ida wajehti chi mouchkil wela 3andek chi 9tira7 matensach t5alih lena fmessage.
            </p>
            ...
            <div className="mt-8 space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3 text-base text-gray-500">
                  ...
                  <p className="mt-1">Casablanca, Morocco</p>
                </div>
              </div>
